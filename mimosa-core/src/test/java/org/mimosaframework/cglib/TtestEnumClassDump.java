...
public class TtestEnumClassDump implements Opcodes {
    ...
    public static byte[] dump() throws Exception {
        ...
        cw.visit(V1_7, ACC_PUBLIC + ACC_FINAL + ACC_SUPER + ACC_ENUM, "org/mimosaframework/cglib/TtestEnumClass", "Ljava/lang/Enum<Lorg/mimosaframework/cglib/TtestEnumClass;>;", "java/lang/Enum", null);
