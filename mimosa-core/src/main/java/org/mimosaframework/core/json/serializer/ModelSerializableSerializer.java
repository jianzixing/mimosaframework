 ...
 */
public class ModelSerializableSerializer implements ObjectSerializer {

    public static ModelSerializableSerializer instance = new ModelSerializableSerializer();
    ...
    public void write(ModelSerializer serializer, Object object, Object fieldName, Type fieldType, int features) throws IOException {
        ModelSerializable jsonSerializable = ((ModelSerializable) object);
