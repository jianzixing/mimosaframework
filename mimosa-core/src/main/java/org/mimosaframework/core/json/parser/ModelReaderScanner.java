 ...
 */
public final class ModelReaderScanner extends ModelLexerBase {
    ...
    public ModelReaderScanner(String input){
        this(input, Model.DEFAULT_PARSER_FEATURE);
    }

    public ModelReaderScanner(String input, int features){
        this(new StringReader(input), features);
    }

    public ModelReaderScanner(char[] input, int inputLength){
        this(input, inputLength, Model.DEFAULT_PARSER_FEATURE);
    }

    public ModelReaderScanner(Reader reader){
        this(reader, Model.DEFAULT_PARSER_FEATURE);
    }

    public ModelReaderScanner(Reader reader, int features){
        super(features);
        this.reader = reader;
    ...
    public ModelReaderScanner(char[] input, int inputLength, int features){
    ...
    public final char charAt(int index) {
        if (index >= bufLength) {
            ...
            if (bp == 0) {
                ...
                if (bufLength == 0) {
                    throw new ModelException("illegal state, textLength is zero");
                }
    ...
    public final char next() {
        ...
        if (index >= bufLength) {
            ...
            if (bufLength == 0) {
                throw new ModelException("illegal stat, textLength is zero");
            }
