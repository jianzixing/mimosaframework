...
public class SerializeConfig {
    ...
    protected String                                      typeKey         = Model.DEFAULT_TYPE_KEY;
	...
	public ObjectSerializer createJavaBeanSerializer(SerializeBeanInfo beanInfo) {
		...
		if (asm) {
			try {
				...
				throw new ModelException("create asm serializer error, class "
						+ clazz, e);
			}
		}
	...
	private ObjectSerializer getObjectWriter(Class<?> clazz, boolean create) {
        ...
        if (writer == null) {
            final ClassLoader classLoader = Model.class.getClassLoader();
        ...
        if (writer == null) {
            ...
            } else if (ModelAware.class.isAssignableFrom(clazz)) {
                put(clazz, ModelAwareSerializer.instance);
            } else if (ModelSerializable.class.isAssignableFrom(clazz)) {
                put(clazz, ModelSerializableSerializer.instance);
            } else if (ModelStreamAware.class.isAssignableFrom(clazz)) {
