...
import static org.mimosaframework.core.json.util.ASMUtils.desc;
...
import org.mimosaframework.core.json.asm.ClassWriter;
import org.mimosaframework.core.json.asm.FieldWriter;
import org.mimosaframework.core.json.asm.Label;
import org.mimosaframework.core.json.asm.MethodVisitor;
import org.mimosaframework.core.json.asm.MethodWriter;
import org.mimosaframework.core.json.asm.Opcodes;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    final static String         DefaultJSONParser = ASMUtils.type(DefaultModelParser.class);
    final static String         JSONLexerBase     = ASMUtils.type(ModelLexerBase.class);
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig config, JavaBeanInfo beanInfo) throws Exception {
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, classNameType, ASMUtils.type(JavaBeanDeserializer.class), null);
    ...
    private void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(org.mimosaframework.core.json.asm.Type.getType(ASMUtils.desc(fieldClass)));
                mw.visitVarInsn(ALOAD, 1);
                mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "getSymbolTable", "()" + ASMUtils.desc(SymbolTable.class));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "scanEnum",
                                   "(Ljava/lang/Class;" + ASMUtils.desc(SymbolTable.class) + "C)Ljava/lang/Enum;");
                ...
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "scanInt", "(C)I");
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(EnumDeserializer.class), "valueOf", "(I)Ljava/lang/Enum;");
                mw.visitJumpInsn(GOTO, enumStore_);
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class), "scanEnum",
                ...
                if (itemClass == String.class) {
                    if (fieldClass == List.class || fieldClass == Collections.class || fieldClass == ArrayList.class) {
                        ...
                        mw.visitInsn(DUP);
                        mw.visitMethodInsn(INVOKESPECIAL, ASMUtils.type(ArrayList.class), "<init>", "()V");
                    } else {
                        mw.visitLdcInsn(org.mimosaframework.core.json.asm.Type.getType(ASMUtils.desc(fieldClass)));
                        mw.visitMethodInsn(INVOKESTATIC, ASMUtils.type(TypeUtils.class), "createCollection",
                    ...
                    mw.visitLdcInsn(ModelLexerBase.VALUE_NULL);
                    ...
                    int token = i == 0 ? ModelToken.LBRACKET : ModelToken.COMMA;
                    ...
                    mw.visitInsn(POP);
                    mw.visitVarInsn(ALOAD, context.var("lexer"));
                    mw.visitLdcInsn(ModelToken.LBRACKET);
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(org.mimosaframework.core.json.asm.Type.getType(ASMUtils.desc(itemClass)));
                    mw.visitVarInsn(ALOAD, 3);
                    mw.visitMethodInsn(INVOKESTATIC, ASMUtils.type(JavaBeanDeserializer.class),
                                       "parseArray",
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitLdcInsn(i);
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class), "getFieldType",
                ...
                if (fieldClass == java.util.Date.class) {
                    ...
                    mw.visitMethodInsn(INVOKESPECIAL, ASMUtils.type(java.util.Date.class), "<init>", "(J)V");
                    mw.visitVarInsn(ASTORE, context.var(fieldInfo.name + "_asm"));
                ...
                _quickNextToken(context, mw, ModelToken.LBRACKET);
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                if (!last) {
                    mw.visitLdcInsn(ModelToken.COMMA);
                } else {
                    mw.visitLdcInsn(ModelToken.RBRACKET);
                }
                mw.visitMethodInsn(INVOKESPECIAL, //
                                   ASMUtils.type(JavaBeanDeserializer.class), //
                                   "check", "(" + ASMUtils.desc(ModelLexer.class) + "I)V");
        ...
        mw.visitVarInsn(ILOAD, context.var("ch"));
        mw.visitVarInsn(BIPUSH, (char) ModelLexer.EOI);
        mw.visitJumpInsn(IF_ICMPNE, quickElse_);
        ...
        mw.visitInsn(POP);
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitLdcInsn(ModelToken.EOF);
        mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "setToken", "(I)V");
        mw.visitJumpInsn(GOTO, quickEnd_);
    ...
    private void _deserialze(ClassWriter cw, Context context) {
        ...
        mw.visitLdcInsn(ModelLexerBase.NOT_MATCH);
        mw.visitJumpInsn(IF_ICMPEQ, super_);

        mw.visitVarInsn(ALOAD, 1); // parser
        mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "getContext", "()" + ASMUtils.desc(ParseContext.class));
...

        {
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "setContext", //
                               "(" + ASMUtils.desc(ParseContext.class) + "Ljava/lang/Object;Ljava/lang/Object;)"
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETFIELD, JSONLexerBase, "matchStat", "I");
        mw.visitLdcInsn(ModelLexerBase.END);
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "scanFieldSymbol",
                                   "([C" + ASMUtils.desc(SymbolTable.class) + ")Ljava/lang/String;");
                mw.visitInsn(DUP);
                ...
                mw.visitMethodInsn(INVOKESTATIC, ASMUtils.type(fieldClass), "valueOf",
                                   "(Ljava/lang/String;)" + ASMUtils.desc(fieldClass));
                mw.visitVarInsn(ASTORE, context.var(fieldInfo.name + "_asm"));
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(org.mimosaframework.core.json.asm.Type.getType(ASMUtils.desc(fieldClass))); // cast
        ...
        if (buildMethod != null) {
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(context.getInstClass()), buildMethod.getName(),
        ...
        mw.visitVarInsn(ALOAD, context.var("instance"));
        mw.visitVarInsn(ILOAD, 4);
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class),
        ...
        mw.visitVarInsn(ALOAD, 3);
        mw.visitVarInsn(ILOAD, 4);
        mw.visitMethodInsn(INVOKESPECIAL, ASMUtils.type(JavaBeanDeserializer.class), //
                           "deserialze", //
                           "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;I)Ljava/lang/Object;");
        mw.visitInsn(ARETURN);
    ...
    private void defineVarLexer(Context context, MethodVisitor mw) {
        mw.visitVarInsn(ALOAD, 1);
        mw.visitFieldInsn(GETFIELD, DefaultJSONParser, "lexer", ASMUtils.desc(ModelLexer.class));
    ...
    private void _createInstance(Context context, MethodVisitor mw) {
        ...
        if (Modifier.isPublic(defaultConstructor.getModifiers())) {
            ...
            mw.visitMethodInsn(INVOKESPECIAL, ASMUtils.type(defaultConstructor.getDeclaringClass()), "<init>", "()V");
            ...
            mw.visitVarInsn(ALOAD, 1);
            mw.visitVarInsn(ALOAD, 0);
            mw.visitFieldInsn(GETFIELD, ASMUtils.type(JavaBeanDeserializer.class), "clazz", "Ljava/lang/Class;");
            mw.visitMethodInsn(INVOKESPECIAL, ASMUtils.type(JavaBeanDeserializer.class), "createInstance",
    ...
    private void _loadAndSet(Context context, MethodVisitor mw, FieldInfo fieldInfo) {
        ...
        if (fieldClass == boolean.class) {
            ...
            if (fieldInfo.method != null) {
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(context.getInstClass()), fieldInfo.method.getName(),
                                   desc(fieldInfo.method));
                if (!fieldInfo.method.getReturnType().equals(Void.TYPE)) {
                    mw.visitInsn(POP);
                }
            } else {
                mw.visitFieldInsn(PUTFIELD, ASMUtils.type(fieldInfo.declaringClass), fieldInfo.field.getName(),
    ...
    private void _set(Context context, MethodVisitor mw, FieldInfo fieldInfo) {
        if (fieldInfo.method != null) {
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(fieldInfo.declaringClass), fieldInfo.method.getName(),
                               desc(fieldInfo.method));
    ...
    private void _setContext(Context context, MethodVisitor mw) {
        mw.visitVarInsn(ALOAD, 1); // parser
        mw.visitVarInsn(ALOAD, context.var("context"));
        mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "setContext", "(" + ASMUtils.desc(ParseContext.class) + ")V");
        ...
        mw.visitVarInsn(ALOAD, context.var("childContext"));
        mw.visitVarInsn(ALOAD, context.var("instance"));
        mw.visitFieldInsn(PUTFIELD, ASMUtils.type(ParseContext.class), "object", "Ljava/lang/Object;");
    ...
    private void _deserialize_endCheck(Context context, MethodVisitor mw, Label reset_) {
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "token", "()I");
        mw.visitLdcInsn(ModelToken.RBRACE);
        mw.visitJumpInsn(IF_ICMPNE, reset_);
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "token", "()I");
        mw.visitLdcInsn(ModelToken.NULL);
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "token", "()I");
        mw.visitLdcInsn(ModelToken.SET);
        ...
        if (isPrimitive) {
            mw.visitMethodInsn(INVOKEINTERFACE, ASMUtils.type(ObjectDeserializer.class), "getFastMatchToken", "()I");
            ...
            mw.visitInsn(POP);
            mw.visitLdcInsn(ModelToken.LBRACE);
            mw.visitVarInsn(ISTORE, context.var("fastMatchToken"));

            _quickNextToken(context, mw, ModelToken.LBRACE);
        }
        ...
        { // setContext
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "setContext",
                               "(Ljava/lang/Object;Ljava/lang/Object;)" + ASMUtils.desc(ParseContext.class));
            mw.visitInsn(POP);
        }
        ...
        mw.visitFieldInsn(GETFIELD, context.className, fieldInfo.name + "_asm_list_item_deser__",
                          ASMUtils.desc(ObjectDeserializer.class));
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(org.mimosaframework.core.json.asm.Type.getType(ASMUtils.desc(itemType)));
        mw.visitVarInsn(ILOAD, context.var("i"));
        mw.visitMethodInsn(INVOKESTATIC, "java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;");
        mw.visitMethodInsn(INVOKEINTERFACE, ASMUtils.type(ObjectDeserializer.class), "deserialze",
        ...
        if (fieldClass.isInterface()) {
            mw.visitMethodInsn(INVOKEINTERFACE, ASMUtils.type(fieldClass), "add", "(Ljava/lang/Object;)Z");
        } else {
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(fieldClass), "add", "(Ljava/lang/Object;)Z");
        }
        mw.visitInsn(POP);
    ...
    private void _quickNextToken(Context context, MethodVisitor mw, int token) {
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "getCurrent", "()C");
        if (token == ModelToken.LBRACE) {
            mw.visitVarInsn(BIPUSH, '{');
        } else if (token == ModelToken.LBRACKET) {
            mw.visitVarInsn(BIPUSH, '[');
        } else {
    ...
    private void _quickNextTokenComma(Context context, MethodVisitor mw) {
        ...
        mw.visitVarInsn(ILOAD, context.var("ch"));
        mw.visitVarInsn(BIPUSH, ModelLexer.EOI);
        mw.visitJumpInsn(IF_ICMPNE, quickElse_);
    ...
    private void _getCollectionFieldItemDeser(Context context, MethodVisitor mw, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "getConfig", "()" + ASMUtils.desc(ParserConfig.class));
        mw.visitLdcInsn(org.mimosaframework.core.json.asm.Type.getType(ASMUtils.desc(itemType)));
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(ParserConfig.class), "getDeserializer",
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(DefaultModelParser.NeedToResolve);
        mw.visitJumpInsn(IF_ICMPNE, _end_if);

        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "getLastResolveTask", "()" + ASMUtils.desc(DefaultModelParser.ResolveTask.class));
        mw.visitVarInsn(ASTORE, context.var("resolveTask"));

        mw.visitVarInsn(ALOAD, context.var("resolveTask"));
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "getContext", "()" + ASMUtils.desc(ParseContext.class));
        mw.visitFieldInsn(PUTFIELD, ASMUtils.type(DefaultModelParser.ResolveTask.class), "ownerContext", ASMUtils.desc(ParseContext.class));

        mw.visitVarInsn(ALOAD, context.var("resolveTask"));
        mw.visitVarInsn(ALOAD, 0);
        mw.visitLdcInsn(fieldInfo.name);
        mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class), "getFieldDeserializer",
                           "(Ljava/lang/String;)" + ASMUtils.desc(FieldDeserializer.class));
        mw.visitFieldInsn(PUTFIELD, ASMUtils.type(DefaultModelParser.ResolveTask.class), "fieldDeserializer", ASMUtils.desc(FieldDeserializer.class));

        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(DefaultModelParser.NONE);
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass, int i) {
        ...
        if ((fieldInfo.parserFeatures & Feature.SupportArrayToBean.mask) != 0) {
            ...
            if (fieldInfo.fieldType instanceof Class) {
                mw.visitLdcInsn(org.mimosaframework.core.json.asm.Type.getType(desc(fieldInfo.fieldClass)));
            } else {
                mw.visitVarInsn(ALOAD, 0);
                mw.visitLdcInsn(i);
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class), "getFieldType",
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class), "deserialze",
                               "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;I)Ljava/lang/Object;");
            mw.visitTypeInsn(CHECKCAST, ASMUtils.type(fieldClass)); // cast
            mw.visitVarInsn(ASTORE, context.var(fieldInfo.name + "_asm"));
    ...
    private void _getFieldDeser(Context context, MethodVisitor mw, FieldInfo fieldInfo) {
        Label notNull_ = new Label();
        mw.visitVarInsn(ALOAD, 0);
        mw.visitFieldInsn(GETFIELD, context.className, fieldInfo.name + "_asm_deser__", ASMUtils.desc(ObjectDeserializer.class));
        mw.visitJumpInsn(IFNONNULL, notNull_);
        ...
        mw.visitFieldInsn(PUTFIELD, context.className, fieldInfo.name + "_asm_deser__", ASMUtils.desc(ObjectDeserializer.class));
    ...
    private void _init(ClassWriter cw, Context context) {
        ...
        MethodVisitor mw = new MethodWriter(cw, ACC_PUBLIC, "<init>",
                                            "(" + ASMUtils.desc(ParserConfig.class) + ASMUtils.desc(JavaBeanInfo.class) + ")V", null, null);
        mw.visitVarInsn(ALOAD, 0);
        mw.visitVarInsn(ALOAD, 1);
        mw.visitVarInsn(ALOAD, 2);
        mw.visitMethodInsn(INVOKESPECIAL, ASMUtils.type(JavaBeanDeserializer.class), "<init>",
                           "(" + ASMUtils.desc(ParserConfig.class) + ASMUtils.desc(JavaBeanInfo.class) + ")V");
