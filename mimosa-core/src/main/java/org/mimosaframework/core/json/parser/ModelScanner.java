 ...
 */
public final class ModelScanner extends ModelLexerBase {

    private final String text;
    private final int    len;

    public ModelScanner(String input){
        this(input, Model.DEFAULT_PARSER_FEATURE);
    }

    public ModelScanner(String input, int features){
        super(features);
    ...
    public ModelScanner(char[] input, int inputLength){
        this(input, inputLength, Model.DEFAULT_PARSER_FEATURE);
    }

    public ModelScanner(char[] input, int inputLength, int features){
    ...
    public boolean scanISO8601DateIfMatch(boolean strict) {
        ...
        if ((!strict) && rest > 13) {
            ...
            if (c0 == '/' && c1 == 'D' && c2 == 'a' && c3 == 't' && c4 == 'e' && c5 == '(' && c_r0 == '/'
                ...
                token = ModelToken.LITERAL_ISO8601_DATE;
                return true;
            }
        }
