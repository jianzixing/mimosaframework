...
public class FieldSerializer implements Comparable<FieldSerializer> {
    ...
    public void writePrefix(ModelSerializer serializer) throws IOException {
    ...
    public void writeValue(ModelSerializer serializer, Object propertyValue) throws Exception {
        if (runtimeInfo == null) {
