 ...
 */
public class ModelSerializer extends SerializeFilterable {
    ...
    public ModelSerializer(SerializeWriter out){
        this(out, SerializeConfig.getGlobalInstance());
    }

    public ModelSerializer(SerializeConfig config){
        this(new SerializeWriter(), config);
    }

    public ModelSerializer(SerializeWriter out, SerializeConfig config){
        this.out = out;
        this.config = config;
    }
    ...
    public static void write(Writer out, Object object) {
        ...
        try {
            ModelSerializer serializer = new ModelSerializer(writer);
