 ...
 */
public class ModelAwareSerializer implements ObjectSerializer {

    public static ModelAwareSerializer instance = new ModelAwareSerializer();
    ...
    public void write(ModelSerializer serializer, Object object, Object fieldName, Type fieldType, int features) throws IOException {
        ...
        ModelAware aware = (ModelAware) object;
