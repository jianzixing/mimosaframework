...
import org.mimosaframework.core.json.parser.deserializer.ParseProcess;
 ...
 * String json = Model.toJSONString(model); // serializes model to Json
 * Model model2 = Model.parseObject(json, Model.class); // deserializes json into model2
 * </pre>
 * <p>
 ...
 * @see TypeReference
 */
public abstract class Model implements ModelStreamAware, ModelAware {
    ...
    public static Object parse(String text, int features) {
        ...
        DefaultModelParser parser = new DefaultModelParser(text, ParserConfig.getGlobalInstance(), features);
    ...
    public static Object parse(byte[] input, int off, int len, CharsetDecoder charsetDecoder, int features) {
        ...
        DefaultModelParser parser = new DefaultModelParser(chars, position, ParserConfig.getGlobalInstance(), features);
        Object value = parser.parse();
    ...
    public static ModelObject parseObject(String text, Feature... features) {
        return (ModelObject) parse(text, features);
    }
    ...
    public static ModelObject parseObject(String text) {
        ...
        return (ModelObject) Model.toJSON(obj);
    }
    ...
    public static <T> T parseObject(String input, Type clazz, int featureValues, Feature... features) {
        ...
        DefaultModelParser parser = new DefaultModelParser(input, ParserConfig.getGlobalInstance(), featureValues);
    ...
    public static <T> T parseObject(String input, Type clazz, ParserConfig config, ParseProcess processor,
        ...
        DefaultModelParser parser = new DefaultModelParser(input, config, featureValues);
    ...
    public static <T> T parseObject(char[] input, int length, Type clazz, Feature... features) {
        ...
        DefaultModelParser parser = new DefaultModelParser(input, length, ParserConfig.getGlobalInstance(), featureValues);
        T value = (T) parser.parseObject(clazz);
    ...
    public static ModelArray parseArray(String text) {
        ...
        DefaultModelParser parser = new DefaultModelParser(text, ParserConfig.getGlobalInstance());
        ...
        if (lexer.token() == ModelToken.NULL) {
            lexer.nextToken();
            array = null;
        } else if (lexer.token() == ModelToken.EOF) {
            array = null;
        } else {
    ...
    public static <T> List<T> parseArray(String text, Class<T> clazz) {
        ...
        if (token == ModelToken.NULL) {
            lexer.nextToken();
            list = null;
        } else if (token == ModelToken.EOF && lexer.isBlankInput()) {
            list = null;
        } else {
    ...
    public static String toJSONString(Object object, int defaultFeatures, SerializerFeature... features) {
        ...
        try {
            ModelSerializer serializer = new ModelSerializer(out);
    ...
    public static String toJSONString(Object object, // 
        ...
        try {
            ModelSerializer serializer = new ModelSerializer(out, config);
    ...
    public static void writeJSONString(Writer writer, Object object, SerializerFeature... features) {
        writeJSONString(writer, object, Model.DEFAULT_GENERATE_FEATURE, features);
    }
    ...
    public static final int writeJSONString(OutputStream os, // 
        ...
        try {
            ModelSerializer serializer = new ModelSerializer(writer, config);
    ...
    public String toJSONString() {
        ...
        try {
            new ModelSerializer(out).write(this);
            return out.toString();
        } finally {
            out.close();
        }
    ...
    public static Object toJSON(Object javaObject, SerializeConfig config) {
        ...
        if (javaObject instanceof Model) {
            return javaObject;
        }
        ...
        if (javaObject instanceof Map) {
            ...
            ModelObject json = new ModelObject(map.size());
        ...
        if (javaObject instanceof Collection) {
            ...
            ModelArray array = new ModelArray(collection.size());
        ...
        if (clazz.isArray()) {
            ...
            ModelArray array = new ModelArray(len);
        ...
        if (serializer instanceof JavaBeanSerializer) {
            ...
            try {
                ...
                throw new ModelException("toJSON error", e);
            }
            return json;
        }
    ...
    public static <T> T toJavaObject(Model json, Class<T> clazz) {
