...
public class ObjectArrayCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    private <T> T toObjectArray(DefaultModelParser parser, Class<?> componentType, ModelArray array) {
        if (array == null) {
            return null;
        }
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (componentType.isArray()) {
                ...
                if (componentType.isInstance(value)) {
                    ...
                    element = toObjectArray(parser, componentType, (ModelArray) value);
                }
                ...
                if (value instanceof ModelArray) {
                    ...
                    ModelArray valueArray = (ModelArray) value;
