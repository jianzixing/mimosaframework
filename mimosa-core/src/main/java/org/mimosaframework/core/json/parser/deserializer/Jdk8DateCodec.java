...
public class Jdk8DateCodec extends ContextObjectDeserializer implements ObjectSerializer, ContextObjectSerializer, ObjectDeserializer {
    ...
    public <T> T deserialze(DefaultModelParser parser, Type type, Object fieldName, String format, int feature) {
    ...
    @Override
    public void write(ModelSerializer serializer, Object object, BeanContext context) throws IOException {
        SerializeWriter out = serializer.out;
