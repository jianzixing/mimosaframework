...
public class JavaBeanSerializer extends SerializeFilterable implements ObjectSerializer {
    ...
    public void writeDirectNonContext(ModelSerializer serializer, //
                                      Object object, //
                                      Object fieldName, //
                                      Type fieldType, //
    ...
    public void writeAsArray(ModelSerializer serializer, //
                             Object object, //
                             Object fieldName, //
                             Type fieldType, //
                             int features) throws IOException {
    ...
    public void writeAsArrayNonContext(ModelSerializer serializer, //
                                       Object object, //
                                       Object fieldName, //
                                       Type fieldType, //
                                       int features) throws IOException {
    ...
    public void write(ModelSerializer serializer, //
                      Object object, //
                      Object fieldName, //
                      Type fieldType, //
                      int features) throws IOException {
    ...
    protected void writeClassName(ModelSerializer serializer, Object object) {
    ...
    public boolean writeReference(ModelSerializer serializer, Object object, int fieldFeatures) {
    ...
    protected boolean isWriteAsArray(ModelSerializer serializer) {
        return isWriteAsArray(serializer, 0);   
    }

    protected boolean isWriteAsArray(ModelSerializer serializer, int fieldFeatrues) {
    ...
    public Object getFieldValue(Object object, String key) {
        ...
        try {
            ...
            throw new ModelException("getFieldValue error." + key, ex);
    ...
    protected char writeBefore(ModelSerializer jsonBeanDeser, //
    ...
    protected char writeAfter(ModelSerializer jsonBeanDeser, //
                              Object object, char seperator) {
    ...
    protected boolean applyLabel(ModelSerializer jsonBeanDeser, String label) {
