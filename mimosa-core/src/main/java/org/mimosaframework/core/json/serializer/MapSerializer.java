...
//        }
        ...
        try {
            ...
            if (out.isEnabled(SerializerFeature.WriteClassName)) {
                ...
                boolean containsKey = (mapClass == ModelObject.class || mapClass == HashMap.class || mapClass == LinkedHashMap.class)
            ...
            for (Map.Entry entry : map.entrySet()) {
...

                {
                    ...
                    if (preFilters != null && preFilters.size() > 0) {
                        if (entryKey == null || entryKey instanceof String) {
                            ...
                            String strKey = Model.toJSONString(entryKey);
                ...
                if (entryKey instanceof String) {
                    ...
                    if (out.isEnabled(SerializerFeature.BrowserCompatible)
                        ...
                        String strEntryKey = Model.toJSONString(entryKey);
