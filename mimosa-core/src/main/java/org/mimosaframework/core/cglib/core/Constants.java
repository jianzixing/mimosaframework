 ...
 */
public interface Constants extends org.mimosaframework.core.asm.Opcodes {
    ...
    public static final Type TYPE_SIGNATURE = TypeUtils.parseType("org.mimosaframework.core.cglib.core.Signature");
