 ...
 * <p><code>org.mimosaframework.core.cglib.Foo$$EnhancerByCGLIB$$38272841</code><p>
...
public class DefaultNamingPolicy implements NamingPolicy {
     ...
     */
    private final static boolean STRESS_HASH_CODE = Boolean.getBoolean("org.mimosaframework.core.cglib.test.stressHashCodes");
    
    public String getClassName(String prefix, String source, Object key, Predicate names) {
        if (prefix == null) {
            prefix = "org.mimosaframework.core.cglib.empty.Object";
