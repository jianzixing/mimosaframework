...
implements CallbackGenerator
{
    ...
    private static final Type REFLECT_UTILS =
      TypeUtils.parseType("org.mimosaframework.core.cglib.core.ReflectUtils");
    private static final Type METHOD_PROXY =
      TypeUtils.parseType("org.mimosaframework.core.cglib.proxy.MethodProxy");
    private static final Type METHOD_INTERCEPTOR =
      TypeUtils.parseType("org.mimosaframework.core.cglib.proxy.MethodInterceptor");
