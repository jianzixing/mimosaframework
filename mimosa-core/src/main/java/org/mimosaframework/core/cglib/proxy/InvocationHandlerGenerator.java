...
implements CallbackGenerator
{
    ...
    private static final Type INVOCATION_HANDLER =
      TypeUtils.parseType("org.mimosaframework.core.cglib.proxy.InvocationHandler");
    private static final Type UNDECLARED_THROWABLE_EXCEPTION =
      TypeUtils.parseType("org.mimosaframework.core.cglib.proxy.UndeclaredThrowableException");
