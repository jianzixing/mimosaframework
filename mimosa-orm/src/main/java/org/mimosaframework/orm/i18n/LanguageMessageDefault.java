...
public class LanguageMessageDefault implements MessagesRegister {
    ...
    static {
        ...
        words.put("time_field_type_error", "timeForUpdate和timeForCreate标识列只能使用时间类型");
        words.put("field_type_miss", "表 %s 中字段 %s 类型未指定");
        ...
        words.put("compare_mapping_warn_index_del", "需要向表 %s 删除索引 %s");
        ...
        words.put("only_delete_object", "请使用Delete删除对象");
        words.put("only_update_object", "请使用Update更新对象");
        words.put("only_query_object", "请使用Query查询对象");

        // MimosaBeanSessionTemplate
        words.put("model_to_bean_error", "Map转换成JavaBean出错,无法设置字段 %s 的值为 %s");
        words.put("model_to_bean_error_2", "Map转换成JavaBean出错");
