...
public class SQLServerStampInsert extends PlatformStampInsert {
    public SQLServerStampInsert(PlatformStampSection section,
    ...
    public SQLBuilderCombine getSqlBuilder(MappingGlobalWrapper wrapper, StampAction action) {
        ...
        if (insert.select != null) {
            sb.append(" ");
            SQLBuilderCombine combine = (new SQLServerStampBuilder().select()).getSqlBuilder(wrapper, insert.select);
