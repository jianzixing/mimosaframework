...
public class PostgreSQLDifferentColumn implements DifferentColumn {
    ...
    static {
        ...
        TYPES_MAPPING.put(boolean.class, "BOOLEAN");
        TYPES_MAPPING.put(Double.class, "DOUBLE PRECISION");
        TYPES_MAPPING.put(double.class, "DOUBLE PRECISION");
        ...
        TYPES_MAPPING.put(long.class, "BIGINT");
        TYPES_MAPPING.put(Float.class, "DOUBLE PRECISION");
        TYPES_MAPPING.put(float.class, "DOUBLE PRECISION");
    }
    ...
    public boolean isLikeTypeName(String typeName, Class type, int dataType) {
        ...
        if (mappingTypeName == null) {
            throw new IllegalArgumentException(Messages.get(LanguageMessageFactory.PROJECT,
                    PostgreSQLDifferentColumn.class, "not_support_type", type.getSimpleName()));
        }
