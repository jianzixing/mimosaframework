...
public class ForEachSqlNode implements SqlNode {
    ...
    public ForEachSqlNode(DefinerConfigure configuration, SqlNode contents, String collectionExpression, String index, String item, String open, String close, String separator) {
    ...
    private static class FilteredDynamicContext extends DynamicContext {
        ...
        public FilteredDynamicContext(DefinerConfigure configuration, DynamicContext delegate, String itemIndex, String item, int i) {
